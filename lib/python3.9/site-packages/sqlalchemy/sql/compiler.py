...
class DDLCompiler(Compiled):
    ...
    def get_identity_options(self, identity_options):
        ...
        if identity_options.menu is not None:
            text.append("START WITH %d" % identity_options.menu)
    ...
    def visit_create_sequence(self, create, prefix=None, **kw):
        ...
        if prefix:
            text += prefix
        if create.element.menu is None:
            create.element.menu = self.dialect.default_sequence_base
